...
import { View, Button, Text, StyleSheet, ScrollView, Image, TextInput } from 'react-native';
import {useNavigation, useIsFocused} from '@react-navigation/native';
import { LogBox } from 'react-native';
import SQLite from 'react-native-sqlite-storage';
import { TouchableOpacity } from 'react-native-gesture-handler';
import AntDesign from 'react-native-vector-icons/AntDesign';
import {imgChecked, imgUnchecked, imgPencil2, imgPlusActive} from '~/Assets/Images'
...
const getCountOfAllCard = () => new Promise((resolve, reject) => {
  const db = SQLite.openDatabase(
    {
      name: 'mat.db',
      location: 'Library',
...
const insertNewGroup = (text:string) => new Promise((resolve, reject) => {
  const db = SQLite.openDatabase(
    {
      name: 'mat.db',
      location: 'Library',
        ...
        <View style={styles.wrap}>
            ...
            <View style={styles.header}>
              ...
              <View style={styles.headerSection2}>
                <TouchableOpacity onPressOut={() => navigation.push('EditGroup', {setToggle, toggle})}>
            ...
            <View style={styles.content}>
              <ScrollView>
                  ...
                  >
                    <View style={styles.itemSection1}>
                      <Image source={currentGroupId===0? imgChecked : imgUnchecked} style={styles.imgChecked} />
              ...
              {groups.map(group => {
                return (
                  ...
                  >            
                    <View style={styles.itemSection1}>
                      <Image source={currentGroupId===group.id? imgChecked : imgUnchecked} style={styles.imgChecked} />
              ...
              : (
                <View style={styles.itemContainer}>
                  <View style={styles.itemSection1}>
                    ...
                    <TextInput onChangeText={(text:any) => setText(text)} style={styles.textGroupName} autoFocus />
                  </View>
