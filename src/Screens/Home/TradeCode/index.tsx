...
const tradeCode = ({navigation}: Props) => {
  return (
    <View style={styles.body}>
      <TouchableOpacity style={{...styles.imgContainer, borderBottomWidth: 1, borderColor: '#D4D4D4'}}
      onPress={() => navigation.push('CreateCode')}>
          <View style={{flex: 2, justifyContent: 'center'}}>
            <Image source={imgCreatePin} style={{width: 80*2.15, height: 80}} />
          </View>
          <View style={{flex: 1}}>
            <Text style={styles.menuTitle}>교환번호 생성</Text>
            <Text style={styles.menuDescription}>생성된 번호를 교환할 상대에게 알려주세요</Text>
          </View>
      </TouchableOpacity>
      ...
      <View style={{flex: 2, justifyContent: 'center'}}>
          ...
          <View style={{flex: 1}}>
            ...
            <Text style={styles.menuDescription}>받은 교환번호를 입력해주세요</Text>
          </View>
      </TouchableOpacity>
    </View>
  );
